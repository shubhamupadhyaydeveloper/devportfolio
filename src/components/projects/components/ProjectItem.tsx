    ...
    return (
        <div className="border-[2px] border-[#a6a7d8] border-dashed rounded-[10px] w-full h-fit p-[30px]"
            ...
            <div className='flex flex-col  md:flex-row gap-[25px]'>
                <img src='https://images.unsplash.com/photo-1733234976396-87cf34ae6038?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxmZWF0dXJlZC1waG90b3MtZmVlZHw4fHx8ZW58MHx8fHx8' className='rounded-[8px] w-[24vw] h-[30vh]' />
                <div>
                 <div>
                    <h3 className='text-white font-poppins text-[40px] font-bold'>Timeloon</h3>
                    <h3>this is div this is project</h3>
                 </div>
                 <div>
