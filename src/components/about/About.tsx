  ...
  <>
      ...
      <div className="mt-[5vh] font-poppins text-[20px] md:text-[20px] lg:text-[17px] xl:text-[20px]">
        <h1 className="text-start">
          ...
          completed an internship at Heliverse, I am also an
          enthusiast for startup culture, actively seeking opportunities to
          collaborate with startups to gain valuable experience and, eventually,
          launch my own. When I'm not coding, I enjoy watching anime and reading
          books, which inspire me to think creatively and explore new ideas.`
        </h1>
      </div>
